...
class ApplyFormPrivatesCash extends ApplyFormAbstract
{
    ...
    public function prepare()
    {
        ...
        if (isset($this->input['monthly_income']) && trim($this->input['monthly_income'])) {
            $this->preparedData['monthly_income'] = trim($this->input['monthly_income']);
        }

        if (isset($this->input['credit_amount']) && trim($this->input['credit_amount'])) {
            $this->preparedData['credit_amount'] = trim($this->input['credit_amount']);
        }
