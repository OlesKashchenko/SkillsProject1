                            ...
                            <section class="col col-10">
                                ...
                                <div class="row">
                                    ...
                                    <section class="col col-6">
                                        <label class="input"> <i class="icon-prepend fa fa-lock"></i>
                                            <input type="password" name="password" placeholder="Пароль" value="" autocomplete="off">
                                        </label>
                                    </section>
                                </div>
                                ...
                                <div class="row">
                                    <section class="col col-3">
                                        <label class="input"> <i class="icon-prepend fa fa-file-o"></i>
                                            <input type="text" name="created_at" placeholder="Дата создания" value="{{$user->created_at}}" autocomplete="off" readonly>
                                        </label>
                                    </section>
                                    <section class="col col-3">
                                        <label class="input"> <i class="icon-prepend fa fa-floppy-o"></i>
                                            <input type="text" name="updated_at" placeholder="Дата обновления" value="{{$user->updated_at}}" autocomplete="off" readonly>
                                        </label>
                                    </section>
                                    <section class="col col-3">
                                        <label class="input"> <i class="icon-prepend fa fa-sign-in"></i>
                                            <input type="text" name="last_login" placeholder="Дата последнего визита" value="{{$user->last_login}}" autocomplete="off" readonly>
                                        </label>
                                    </section>
                                </div>
