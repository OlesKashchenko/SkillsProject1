...
class BackendUsersController extends Controller
{
    ...
    public function showEditUser($id)
    {
        ...
        return \View::make('backend.users.users_edit', $data);
    } // end showEditUser
    ...
    public function showEditGroup($id)
    {
        ...
        return \View::make('backend.users.groups_edit', compact('group', 'groupPermissions'));
    } // end showEditGroup
    ...
    public function showCreateUser()
    {
        ...
        return \View::make('backend.users.users_create', compact('groups'));
    } // end showCreateUser
    ...
    public function showCreateGroup()
    {
        ...
        return \View::make('backend.users.groups_create');
    } // end showCreateGroup
